...
async def cb_handler(client, query):
    ...
    if query.data == "start_data":
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Nasıl kurabilirim?", url="https://youtu.be/hkmc3e7U7R4"),
                    InlineKeyboardButton("Hakkımda", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("Arşiv Kanalı", url="https://t.me/mishapmarsiv"),
                    InlineKeyboardButton("Uncookies Grubu", url="https://t.me/uncookies")
                ]
            ]
        )
            ...
            [
                [
                    InlineKeyboardButton(
                        "Kaynak Kodu", url="https://github.com/TroJanzHEX/Unlimited-Filter-Bot")
                ],
                [
